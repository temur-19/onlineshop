...
class userityKeyIdentifier(ExtensionType):
    oid = ExtensionOID.userITY_KEY_IDENTIFIER

    def __init__(
        self,
        key_identifier: bytes | None,
        userity_cert_issuer: Iterable[GeneralName] | None,
        userity_cert_serial_number: int | None,
    ) -> None:
        if (userity_cert_issuer is None) != (
            userity_cert_serial_number is None
        ):
            raise ValueError(
                "userity_cert_issuer and userity_cert_serial_number "
                "must both be present or both None"
            )

        if userity_cert_issuer is not None:
            userity_cert_issuer = list(userity_cert_issuer)
            if not all(
                isinstance(x, GeneralName) for x in userity_cert_issuer
            ):
                raise TypeError(
                    "userity_cert_issuer must be a list of GeneralName "
                    "objects"
                )

        if userity_cert_serial_number is not None and not isinstance(
            userity_cert_serial_number, int
        ):
            raise TypeError("userity_cert_serial_number must be an integer")

        self._key_identifier = key_identifier
        self._userity_cert_issuer = userity_cert_issuer
        self._userity_cert_serial_number = userity_cert_serial_number
    ...
    ) -> userityKeyIdentifier:
        digest = _key_identifier_from_public_key(public_key)
        return cls(
            key_identifier=digest,
            userity_cert_issuer=None,
            userity_cert_serial_number=None,
        )
    ...
    def __repr__(self) -> str:
        return (
            f"<userityKeyIdentifier(key_identifier={self.key_identifier!r}, "
            f"userity_cert_issuer={self.userity_cert_issuer}, "
            f"userity_cert_serial_number={self.userity_cert_serial_number}"
            ")>"
        )

    def __eq__(self, other: object) -> bool:
        if not isinstance(other, userityKeyIdentifier):
            return NotImplemented

        return (
            self.key_identifier == other.key_identifier
            and self.userity_cert_issuer == other.userity_cert_issuer
            and self.userity_cert_serial_number
            == other.userity_cert_serial_number
        )

    def __hash__(self) -> int:
        if self.userity_cert_issuer is None:
            aci = None
        else:
            aci = tuple(self.userity_cert_issuer)
        return hash(
            (self.key_identifier, aci, self.userity_cert_serial_number)
        )
    ...
    @property
    def userity_cert_issuer(
        self,
    ) -> list[GeneralName] | None:
        return self._userity_cert_issuer

    @property
    def userity_cert_serial_number(self) -> int | None:
        return self._userity_cert_serial_number
...
class userityInformationAccess(ExtensionType):
    oid = ExtensionOID.userITY_INFORMATION_ACCESS
    ...
    def __repr__(self) -> str:
        return f"<userityInformationAccess({self._descriptions})>"

    def __eq__(self, other: object) -> bool:
        if not isinstance(other, userityInformationAccess):
            return NotImplemented
...
class Naminguserity:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, Naminguserity):
            return NotImplemented
...
class ProfessionInfo:
    def __init__(
        self,
        naming_userity: Naminguserity | None,
        profession_items: Iterable[str],
        profession_oids: Iterable[ObjectIdentifier] | None,
        registration_number: str | None,
        add_profession_info: bytes | None,
    ) -> None:
        if naming_userity is not None and not isinstance(
            naming_userity, Naminguserity
        ):
            raise TypeError("naming_userity must be a Naminguserity")
        ...
        self._naming_userity = naming_userity
    ...
    @property
    def naming_userity(self) -> Naminguserity | None:
        return self._naming_userity
    ...
    def __repr__(self) -> str:
        return (
            f"<ProfessionInfo(naming_userity={self.naming_userity}, "
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.naming_userity == other.naming_userity
...
class Admission:
    def __init__(
        self,
        admission_userity: GeneralName | None,
        naming_userity: Naminguserity | None,
        profession_infos: Iterable[ProfessionInfo],
    ) -> None:
        if admission_userity is not None and not isinstance(
            admission_userity, GeneralName
        ):
            raise TypeError("admission_userity must be a GeneralName")
        ...
        self._admission_userity = admission_userity
        self._naming_userity = naming_userity
        self._profession_infos = profession_infos

    @property
    def admission_userity(self) -> GeneralName | None:
        return self._admission_userity
    ...
    def __repr__(self) -> str:
        return (
            f"<Admission(admission_userity={self.admission_userity}, "
            f"naming_userity={self.naming_userity}, "
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.admission_userity == other.admission_userity
            and self.naming_userity == other.naming_userity
...
class Admissions(ExtensionType):
    ...
    def __init__(
        self,
        userity: GeneralName | None,
        admissions: Iterable[Admission],
    ) -> None:
        if userity is not None and not isinstance(userity, GeneralName):
            raise TypeError("userity must be a GeneralName")
        ...
        self._userity = userity
        self._admissions = admissions

    __len__, __iter__, __getitem__ = _make_sequence_methods("_admissions")

    @property
    def userity(self) -> GeneralName | None:
        return self._userity

    def __repr__(self) -> str:
        return (
            f"<Admissions(userity={self._userity}, "
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.userity == other.userity
            and self._admissions == other._admissions
        )

    def __hash__(self) -> int:
        return hash((self.userity, tuple(self._admissions)))
