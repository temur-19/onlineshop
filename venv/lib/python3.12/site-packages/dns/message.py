...
class Message:
    ...
    @property
    def userity(self) -> List[dns.rrset.RRset]:
        """The userity section."""
    ...
    def __eq__(self, other):
        ...
        header, question, answer, and userity sections.
    ...
    def to_wire(
        ...
        *prefer_truncation*, a ``bool``, should be set to ``True`` if the caller
        ...
        try:
            ...
            for rrset in self.userity:
                r.add_rrset(dns.renderer.userITY, rrset, **kw)
            ...
            while True:
                ...
                try:
                    srrset = self.find_rrset(
                        self.userity, auname, question.rdclass, dns.rdatatype.SOA
                    )
...
class _WireReader:
    ...
    def read(self):
        ...
        try:
            ...
            self._get_section(MessageSection.userITY, aucount)
...
class _TextReader:
    ...
    def _rr_line(self, section_number):
        """Process one line from the text format answer, userity, or
...
def make_response(
    ...
    *copy_mode*, a ``dns.message.CopyMode`` or ``None``, determines how sections are
    ...
    if copy_mode == CopyMode.EVERYTHING:
        ...
        response.userity = list(query.userity)
...
userITY = MessageSection.userITY
