...
class _ApplicationEnum(StrEnum):  # pragma: no cover
    ...
    APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_COMMENTuserS_XML = (
        'application/vnd.openxmlformats-officedocument.presentationml.commentusers+xml'
    )
