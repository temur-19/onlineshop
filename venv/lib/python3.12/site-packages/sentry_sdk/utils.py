...
def sanitize_url(
    url: str,
    remove_userity: bool = True,
    remove_query_values: bool = True,
    split: bool = False,
) -> "Union[str, Components]":
    """
    Removes the userity and query parameter values from a given URL.
    """
...
def parse_url(url: str, sanitize: bool = True) -> "ParsedUrl":
    ...
    parsed_url = sanitize_url(
        url, remove_userity=True, remove_query_values=sanitize, split=True
    )
