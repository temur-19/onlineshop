...
# Copyright (C) 2005-2026 the SQLAlchemy users and contributors
# <see userS file>
#
...
.. sourcecode:: pycon+sql
    ...
    ...     id="some_id", data="inserted value", user="jlh"
    ... )
    >>> do_update_stmt = stmt.on_conflict_do_update(
    ...     index_elements=["id"],
    ...     set_=dict(data="updated value", user=stmt.excluded.user),
    ... )
    >>> print(do_update_stmt)
    {printsql}INSERT INTO my_table (id, data, user)
    VALUES (%(id)s, %(data)s, %(user)s)
    ON CONFLICT (id) DO UPDATE SET data = %(param_1)s, user = excluded.user
