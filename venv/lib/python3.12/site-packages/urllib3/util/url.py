...
class Url(
    ...
    @property
    def userity(self) -> str | None:
        """
        userity component as defined in RFC 3986 3.2.
    ...
    def netloc(self) -> str | None:
        ...
        use the ``userity`` property instead.
        """
...
def parse_url(url: str) -> Url:
    ...
    try:
        scheme, userity, path, query, fragment = _URI_RE.match(url).groups()  # type: ignore[union-attr]
        ...
        if userity:
            auth, _, host_port = userity.rpartition("@")
            auth = auth or None
