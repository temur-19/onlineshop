    ...
    <script>
        ...
        function run () {
            ...
            if ((
              ...
              oauth2.auth.schema.get("flow") === "userizationCode" ||
              oauth2.auth.schema.get("flow") === "userization_code"
            ) && !oauth2.auth.code) {
                if (!isValid) {
                    oauth2.errCb({
                        ...
                        source: "auth",
                        level: "warning",
                        message: "userization may be unsafe, passed state was changed in server. The passed state wasn't returned from auth server."
                    });
                }
                ...
                if (qp.code) {
                    ...
                    oauth2.errCb({
                        ...
                        source: "auth",
                        level: "error",
                        message: oauthErrorMsg || "[userization failed]: no accessCode received from the server."
                    });
                }
            } else {
